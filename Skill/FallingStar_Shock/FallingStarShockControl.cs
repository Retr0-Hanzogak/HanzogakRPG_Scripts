...
public class FallingStarShockControl : MonoBehaviour {
    ...
    private void Update()
    {
        ...
        if (isHit)
        {
            ...
            GameObject instance2 = Instantiate(shockwave, enemyPos, transform.rotation);
            Destroy(instance2, SkillData.instance.skillData[2].playTime);

            GetComponent<FallingStarShockControl>().enabled = false;
        }
    }
}
